...
Route::group(['middleware' => 'web'], function () {
    ...
    Route::any('/alidirect', 'ApplicationController@alidirect'); //支付宝免签约接口zfbjk.com
    Route::any('/alidirect/check', 'ApplicationController@alidirectcheck'); //支付宝免签约接口zfbjk.com
    Route::any('/account/alidirect/{price}', 'ApplicationController@alidirectpay'); //支付宝免签约接口zfbjk.com
...
Route::get('/administrator', 'AdministratorController@users')->name('admin.index');
