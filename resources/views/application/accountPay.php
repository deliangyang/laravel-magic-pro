...
<div class="box">
  <form id="form" class="form-inline" onsubmit='return false;'>
	...
	<button id="alidirect" type='button' style='border:1px solid #5cb85c;' class="btn btn-success">支付宝即时到账（临时）</button>
...
<script>
  window.onload = function () {
    ...
    //提交
     ...
     var alidirect = document.getElementById('alidirect');
	 alidirect.onclick = function () {
      var msg = $('#msg').val();
      if (value == null || value == undefined || value == '') {
        layer.open({
          content: '支付金额不能为空'
        ...
        var price = value;
        window.location.href = '/account/alidirect/' + price;
     }
    }
